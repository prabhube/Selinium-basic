...
public class BoardOfDirectors {
	public static void main(String[] args) throws IOException  {
		...
		WebElement board = driver.findElement(By.xpath("//a[text()='Board of Directors']"));
		a.click(board).perform();;
		TakesScreenshot s=(TakesScreenshot)driver;
		File screenshotAs = s.getScreenshotAs(OutputType.FILE);
		System.out.println(screenshotAs);
		FileUtils.copyFile(screenshotAs, new File("D:\\board of directors.jpg"));
